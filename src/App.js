...
import Card_Title from './pages/Card_Title';
import Cards from './pages/Cards';
import NavBarm from './pages/accorn';
import C_arousel from './pages/C-arousel';
...
import Aducationfactorys from './pages/educationfactorys';
